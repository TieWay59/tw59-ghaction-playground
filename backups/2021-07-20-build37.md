...
`./code/基础/几何/Points-Vector 点与向量.cpp`
...
`./code/基础/几何/Circumcenter 外心 三点定圆.cpp`
...
`./code/基础/几何/MinCircleCover 最小圆覆盖.cpp`
...
`./code/基础/几何/Line-Segment 直线与线段.cpp`
...
`./code/基础/几何/ClosestPoints 最近点对.cpp`
